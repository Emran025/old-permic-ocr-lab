...
const renderedNotebookUrl = "/manus-storage/old-permic-synthetic-generation-notebook_14378bce.html";
      ...
      <main className="mx-auto max-w-[1440px] px-4 py-10 sm:px-6 lg:px-8">
        <header className="flex flex-col gap-6 border-b border-[#ddd4c6] pb-8 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-4 max-w-3xl text-sm leading-8 text-[#62675e]">هذا عارض HTML قياسي مولد من دفتر Jupyter الحقيقي، لا تمثيل يدوي لخلايا الكود. يعرض الدفتر مسار Colab المتدرج: التوليد الحرفي، التحقق، التدريب، الاستئناف، التقييم، ثم إصدار نتائج موثق.</p>
          </div>
