...
const renderedNotebookUrl = "/manus-storage/old-permic-synthetic-generation-notebook_69e93243.html";
      ...
      <main className="mx-auto max-w-[1440px] px-4 py-10 sm:px-6 lg:px-8">
        <header className="flex flex-col gap-6 border-b border-[#ddd4c6] pb-8 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-4 max-w-3xl text-sm leading-8 text-[#62675e]">هذا عارض HTML قياسي مولد من دفتر Jupyter الحقيقي، لا تمثيل يدوي لخلايا الكود. يعرض مسار Colab المتدرج: التوليد الحرفي، التحقق، التدريب، حفظ أحدث checkpoint إلى GitHub بعد كل epoch، ثم التقييم وإصدار نتائج موثق.</p>
          </div>
